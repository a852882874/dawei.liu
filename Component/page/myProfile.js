...
import {
    ...
    TouchableWithoutFeedback, TextInput, Alert, InteractionManager,
    AsyncStorage
} from 'react-native'
...
export default class myProfile extends Component {
    constructor(props) {
        ...
        thatPic = this;
        this.state = {
            avatarSource: this.props.avatarThumbPathImage,//头像
            avatarSourceBase64: "",
        ...
        SplashScreen.hide();
        console.log(this.props.userStart)
    }
    componentDidMount() {
    ...
    _tabQie() {
        return (
            ...
            <View style={myProfileStyle.tabQieWrap}>
                ...
                >
                    <View style={{ paddingRight: cal(20) }}>
                        <Text style={{ color: PublicColor.Public_Text5, fontSize: cal(14) }}>保存</Text>
                    </View>
                </TouchableOpacity>
            </View>
        )
            ...
            >
                <View style={myProfileStyle._contentSubOne}>
                    <View style={{ width: cal(62), height: cal(62), borderRadius: cal(62), justifyContent: "center", alignItems: "center", backgroundColor: PublicColor.Public_ClickBackground }}>
                        ...
                        {/* <View style={{position:"absolute",height:cal(62),justifyContent:"center",alignItems:"center",bottom:0,backgroundColor:"rgba(0,0,0,0.2)", borderRadius: cal(60),width:cal(60)}}>
                            <Text style={{}}>审核中</Text>
                        </View> */}
                    </View>
                    <Image source={ZUO} style={{ width: cal(6.5), height: cal(11.5) }} />
    ...
    _onBlur() {
        ...
        // alert(this.state.userEd2.nickname)
        if (blen < 2) {
                    ...
                    < View style={myProfileStyle._contentSubThree_one} >
                        ...
                        <View style={[myProfileStyle._contentSubThree_one_view]}>
                            <TextInput
                                ...
                                placeholder={(typeof this.state.userEd2.nickname) == undefined ? "未填写" : this.state.userEd2.nickname}
                                        ...
                                        [
                                            {
                                                text: '删除', onPress: () => {
                                                    ...
                                                    if (item.slice(0, 4) == "http") {
                                                        console.log(item.slice(0, 22))
                                                        if (item.slice(0, 22) == "http://api.aityuan.com") {
                                                            let a = { "uuid": item.split('=')[1].split("&")[0] }
    ...
    PickePublic(item, type) {
        ...
        if (type == 1) {
            if (item.name == "生日") {
                ...
                PickerCity._showAreaPicker(json, "male", function (res) {
                ...
                PickerCity._showZhiYe("male", function (res) {
                ...
                PickerCity._showShouRuNam("male", function (res) {
                ...
                PickerCity._showAreaPickerWork(json, "male", function (res) {
                ...
                PickerCity._showXueLi("male", function (res) {
                    // item.state = res[0]
                ...
                PickerCity._showHunYin("male", function (res) {
                    // item.state = res[0]
                ...
                PickerCity._showHaiZi("male", function (res) {
                    // item.state = res[0]
                ...
                PickerCity._showZhufang("male", function (res) {
                    // item.state = res[0]
                ...
                PickerCity._showMaiChe("male", function (res) {
                    // item.state = res[0]
            ...
            // }
                ...
                PickerCity._showXiYan("male", function (res) {
                    // item.state = res[0]
                ...
                PickerCity._showJiu("male", function (res) {
                    // item.state = res[0]
            ...
            // 择偶条件
            if (item.name == "年龄") {
                PickerCity._showOld("male", function (res) {
                ...
                PickerCity._showAreaPickerWorkPerhome(json, "male", function (res) {
                ...
                PickerCity._showShouRuMomPer("male", function (res) {
                    // item.state = res[0]
                ...
                let that = this;
                PickerCity._showHeight("male", function (res) {
                ...
                PickerCity._showHunYinPer("male", function (res) {
                ...
                PickerCity._showAreaPickerWorkPer(json, "male", function (res) {
                    // item.state = res[0] == "不限" ? "不限" : res[0] + '-' + res[1] + '-' + res[2]
                ...
                PickerCity._showXueLiPer("male", function (res) {
                    // item.state = res[0]
                ...
                PickerCity._showHaiZiPei("male", function (res) {
                    // item.state = res[0]
                ...
                PickerCity._showXiYanPer("male", function (res) {
                ...
                PickerCity._showJiuPer("male", function (res) {
                ...
                return (
                    <Text numberOfLines={1} style={[(this.state.userEd2.hometownProvince == null) ? myProfileStyle._contentSubThree_one_view_text : myProfileStyle._contentSubThree_one_view_text_END, { maxWidth: cal(150) }]}>
                        {this.state.userEd2.hometownProvince == null ?
                            "未填写"
                            : (this.state.userEd2.hometownProvince + '-' + this.state.userEd2.hometownCity + '-' + this.state.userEd2.hometownDistrict)
                        }
                    </Text>
                );
            case "职业":
            ...
            case "月收入":
                return (
                    <Text numberOfLines={1} style={[(this.state.userEd2.income == null) ? myProfileStyle._contentSubThree_one_view_text : myProfileStyle._contentSubThree_one_view_text_END, { maxWidth: cal(150) }]}>
                        {this.state.userEd2.income == null ? "未填写" : Education._incomeGet(this.state.userEd2.income, true)}
                    </Text>
                );
            case "工作地区":
                return (
            ...
            case "月收入":
                return (
                    <Text numberOfLines={1} style={[(this.state.userEd2.spouseIncome == null) ? myProfileStyle._contentSubThree_one_view_text : myProfileStyle._contentSubThree_one_view_text_END, { maxWidth: cal(150) }]}>
                        {this.state.userEd2.spouseIncome == null ? "未填写" : Education._incomeGetPer(this.state.userEd2.spouseIncome)}
                    </Text>
                );
            case "婚姻状况":
                return (
    ...
    _sentTiJiao() {
        ...
        let UserList = {
            portraitConfirmed: this.state.avatarSourceBase64 != "" ? "1" : this.props.userStart.portraitConfirmed,
            ...
            username: this.state.content != "" ? this.state.content : this.state.userEd2.username
        }
        let json = {
    ...
    JMessageUserName(that) {
        ...
        let p = new Promise(function (resolve, reject) {
            console.log(that.state.jsonData.nickname)
    ...
    imageUpload(that) {
        let p = new Promise(function (resolve, reject) {
            //做一些异步操作
            if (that.state.avatarSourceBase64 != "" && that.state.imageList.length > 0) {
        ...
        let p = new Promise(function (resolve, reject) {
            ...
            if (that.state.avatarSourceBase64 != "") {
                ...
                _ajax.post_image_token("user/image/upload", formData, function (res) {
                    console.log(res)
                    if (res.code == 0) {
                        AsyncStorage.setItem('Image', JSON.stringify(that.state.avatarSource2), () => { });
                        resolve("更新头像ok")
                    } else {
                        that.setState({
                            Loadding: false
