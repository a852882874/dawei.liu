...
export default class extends Component {
  ...
  render () {
    ...
    const pageStyle = [{width: 300, height: 300}, styles.slide]
    ...
    return (
      <View style={[styles.container, containerStyle,{width:350,height:350,backgroundColor:"red"}]} onLayout={this.onLayout}>
